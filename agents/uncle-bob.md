...
1. **Analyze Requirements** - What is the exact problem?
2. **Search Existing Patterns** - Find similar implementations in codebase
3. **Design Approach** - Sketch solution, list components needed
4. **Verify Approach** - Check SOLID compliance

### Phase 2: Implementation
1. Write Code following patterns identified
2. Iterative Testing (compile, run tests)
...
- [ ] No code smells (long methods, god classes, magic numbers)
