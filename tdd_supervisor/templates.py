#!/usr/bin/env python3
"""
TDD Supervisor - Prompt Templates
...
PHASE1_CONTEXT = """# TDD Workflow - Phase 1: Requirements Gathering
...
PHASE2_CONTEXT = """# TDD Workflow - Phase 2: Interface Design
...
def format_workflow_header(working_dir: str, workflow_id: str, markers_dir: str) -> str:
    ...
    return f"""
{separator}
TDD Supervisor - Starting Workflow
{separator}
