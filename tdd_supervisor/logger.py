#!/usr/bin/env python3
"""
TDD Supervisor - Workflow Logger

Provides logging functionality for supervisor workflows.
Logs are stored in the workflow directory alongside documents.
"""
...
class SupervisorLogger:
    """Logger for TDD supervisor workflow events."""
    ...
    def log_event(self, category: str, message: str) -> None:
        """
        Log an event to the workflow log file.
