#!/usr/bin/env python3
"""
Unit tests for tdd_supervisor/templates.py - Prompt templates and formatting functions
"""
...
sys.path.insert(0, '.')
from tdd_supervisor import templates
...
class TestFormatWorkflowHeader:
    ...
    def test_format_workflow_header_has_title(self):
        ...
        assert "TDD Supervisor" in result
