...
Provides logging functionality for TDD hooks.
Named tdd_logging to avoid conflict with stdlib logging module.
"""
...
class TDDLogger:
    """Logger for TDD workflow events."""

    def __init__(self, session_id: str = "unknown"):
        """Initialize logger with session ID."""
        install_dir = os.environ.get("TDD_INSTALL_DIR", str(Path.home() / ".claude" / "tdd-workflow"))
    ...
    def log_tdd(self, message: str) -> None:
        """Log TDD-specific event."""
        self.log_event("TDD", message)
