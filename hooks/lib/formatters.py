#!/usr/bin/env python3
"""
TDD Workflow - Output Formatters
...
def format_phase4_compile_error(
    ...
    return f"""## TDD Phase 4: Compilation FAILED ({profile_name})
...
def format_phase4_test_failure(
    ...
    return f"""## TDD Phase 4: Compilation PASSED, Tests FAILED ({profile_name})
...
def format_phase_guard_phase1_block(file_path: str, profile_name: str) -> str:
    """Format Phase 1 block message for source file edit attempt."""
    return f"""## TDD Phase 1: Requirements Gathering ({profile_name})
...
def format_phase_guard_phase2_block(file_path: str, profile_name: str) -> str:
    """Format Phase 2 block message for test file edit attempt."""
    return f"""## TDD Phase 2: Interface Design ({profile_name})
...
def format_phase_guard_phase3_block(file_path: str, profile_name: str) -> str:
    """Format Phase 3 block message for implementation file edit attempt."""
    return f"""## TDD Phase 3: Test Writing ({profile_name})
...
def format_phase1_block(marker_dir: str) -> str:
    ...
    return f"""## TDD Phase 1: Requirements Gathering
...
def format_phase4_orchestrator_compile_error(
    ...
    return f"""## TDD Phase 4: Implementation Loop ({profile_name})
